...
public:
    ...
    {
        Window_ReturnBook->setWindowTitle(QApplication::translate("Window_ReturnBook", "Dialog", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tableWidget_BorrowedBooks->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("Window_ReturnBook", "BookName", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget_BorrowedBooks->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("Window_ReturnBook", "Subject", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget_BorrowedBooks->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("Window_ReturnBook", "Author", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget_BorrowedBooks->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("Window_ReturnBook", "RentedUntil", nullptr));
        pushButton_ReturnBook->setText(QApplication::translate("Window_ReturnBook", "ReturnBook", nullptr));
    } // retranslateUi
