...
public:
    ...
    {
        Window_RemoveReservation->setWindowTitle(QCoreApplication::translate("Window_RemoveReservation", "Dialog", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tableWidget_ReservedBooks->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("Window_RemoveReservation", "BookName", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget_ReservedBooks->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("Window_RemoveReservation", "Subject", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget_ReservedBooks->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("Window_RemoveReservation", "Author", nullptr));
        pushButton_CancelReservation->setText(QCoreApplication::translate("Window_RemoveReservation", "CancelReservation", nullptr));
    } // retranslateUi
